  ...
  return (
    <div className="bg-gradient-to-r from-gray-900 to-gray-700 min-h-screen flex flex-col justify-center items-center p-4 md:p-10">
      <div className="bg-white shadow-2xl rounded-lg p-6 md:p-8 max-w-2xl w-full">
        <h1 className="text-3xl md:text-4xl font-extrabold text-gray-800 text-center mb-4">Contact Us</h1>
        <p className="text-gray-600 text-center mb-6">
          Have any questions? Feel free to reach out to us. We're here to help you with all your real estate needs.
        </p>
      ...
      <div className="mt-8 text-gray-300 text-center">
        <p className="font-semibold text-base md:text-lg mb-2">
          📧 Email: <span className="text-blue-400">support@realstatemanagement.com</span>
        </p>
        <p className="font-semibold text-base md:text-lg mb-2">
          📞 Phone: <span className="text-blue-400">+25 19 34 56 78 90</span>
        </p>
        <p className="font-semibold text-base md:text-lg">
          📍 Address: <span className="text-blue-400">123 Real Estate Ave, City, Country</span>
        </p>
      </div>
    </div>
  );
