...
const BookingHouse = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      formData.append('totalPrice', String(totalAmount)); // Remove commission from total price
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        <div>
          ...
          <div className="space-y-2 text-gray-700 mb-6">
            ...
            {/* Removed commission and total with commission display */}
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          ...
          <Form form={form} onFinish={handleSubmit} layout="vertical">
            ...
            >
              <Checkbox>
                I confirm that this national ID is my own
              </Checkbox>
            </Form.Item>
